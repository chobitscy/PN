...
from blueprints import video, product, star, tag, user, follow, comment, collection, element
...
def create_app():
    ...
    app.register_blueprint(collection.cl)
    app.register_blueprint(element.el)
    return app
